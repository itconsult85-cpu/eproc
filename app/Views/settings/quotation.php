    ...
    <div class="row g-3">
        <div class="col-lg-8">
            ...
            <div class="card card-secondary card-outline">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4"><label class="field-label">PPN (%)</label>
                        ...
                        <div class="col-md-4"><label class="field-label">Masa berlaku (hari)</label>
                        ...
                        <div class="col-md-4"><label class="field-label">Nama penandatangan</label>
                            <input name="signer_name" class="form-control"
                                value="<?= old('signer_name', $settings['signer_name'] ?? '') ?>">
                        </div>
                        <div class="col-md-6"><label class="field-label">Syarat pembayaran</label>
                        ...
                        <div class="col-md-6"><label class="field-label">Syarat pengiriman</label>
                        ...
                        <div class="col-md-6"><label class="field-label">Telepon penandatangan</label>
        ...
        <div class="col-lg-4">
            <div class="card card-warning card-outline">
                ...
                <div class="card-body">
                    ...
                    <label class="field-label">Tanda tangan (image)</label>
                    ...
                    <label class="field-label">Stempel (image)</label>
