...
<form method="post" action="<?= esc($action) ?>" enctype="multipart/form-data" class="card card-primary card-outline">
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-12">
                <label class="form-label">Aplikasi / Fungsi Utama</label>
            ...
            <div class="col-12">
                <label class="form-label">Sertifikasi / Standar</label>
                <input name="standards"
                    class="form-control" placeholder="Contoh: SNI 7079, CE EN ISO 20345"
            ...
            <div class="col-12">
                ...
                <button type="button" class="btn btn-sm btn-outline-primary"
                    onclick="addSpec()"><i class="bi bi-plus-lg"></i> Tambah parameter
                </button>
            </div>
            <div class="col-12">
                <label class="form-label">Catatan Datasheet</label>
                <textarea name="datasheet"
                    class="form-control" rows="3"
            ...
            <div class="col-md-4">
                ...
                <?php if (!empty($product['image_path'])): ?>
                    <img src="<?= esc($product['image_path']) ?>"
                        class="img-thumbnail mt-2" style="max-height:120px" alt="Gambar produk">
                <?php endif; ?>
            </div>
            <div class="col-md-4">
                <label class="form-label">Upload Video Produk</label>
                <input type="file" name="video"
                    accept="video/mp4,video/webm,video/quicktime" class="form-control">
                <div class="form-text">MP4, WEBM, MOV maksimal 50 MB.</div>
                <?php if (!empty($product['video_path'])): ?>
                    <a href="<?= esc($product['video_path']) ?>"
                        target="_blank" class="btn btn-sm btn-outline-secondary mt-2">Lihat video tersimpan
                    </a>
                <?php endif; ?>
            </div>
            <div class="col-md-4">
                <label class="form-label">Upload File Datasheet</label>
                <input type="file"
                    name="datasheet_file" accept="application/pdf" class="form-control">
            ...
            <div class="col-md-4">
                ...
                <input name="store_name"
                    class="form-control" value="<?= old('store_name', $product['store_name'] ?? '') ?>">
            </div>
            <div class="col-md-4">
                <label class="form-label">URL Toko Online</label>
                <input type="url" name="store_url"
                    class="form-control" value="<?= old('store_url', $product['store_url'] ?? '') ?>">
            </div>
            <div class="col-md-4">
                <label class="form-label">Telepon Toko</label>
                <input name="store_phone"
                    class="form-control" value="<?= old('store_phone', $product['store_phone'] ?? '') ?>">
            </div>
            <div class="col-md-4">
                <label class="form-label">PIC Toko</label>
            ...
            <div class="col-md-4">
                ...
                <select name="is_active" class="form-control">
                    ...
                    <option value="0" <?= old('is_active', $product['is_active'] ?? 1) == 0 ? 'selected' : '' ?>>
                        Tidak Aktif
                    </option>
                </select>
            </div>
    ...
    <div class="card-footer">
        <a href="/products" class="btn btn-light">Batal</a>
