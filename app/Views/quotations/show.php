...
<div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-3">
    ...
    <div class="d-flex flex-wrap gap-2">
        <a href="<?= esc(site_url('quotations/' . public_id($quotation['id']) . '/edit')) ?>" class="btn btn-warning text-nowrap">
        ...
        <?php if ($quotation['status'] === 'approved'): ?><a href="<?= esc(site_url('quotations/' . public_id($quotation['id']) . '/proforma-invoice')) ?>" class="btn btn-success text-nowrap"><i class="bi bi-receipt me-1"></i>Cetak Proforma Invoice</a><?php endif; ?>
    </div>
</div>
