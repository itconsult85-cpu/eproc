    ...
    <div class="app-wrapper">
            ...
            <div class="container-fluid">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block">
                        <a href="/" class="nav-link fw-semibold">Eprocurement
                            Workspace</a>
                    </li>
                </ul>
            </div>
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            <div class="sidebar-brand">
                <a href="<?= esc(site_url('/')) ?>" class="brand-link text-decoration-none">
                    <?php if ($sidebarLogo): ?>
            ...
            <div class="app-content">
                <div class="container-fluid">
                    ...
                    <div class="alert alert-danger alert-dismissible fade show">
                        ...
                        <ul class="mb-0 d-inline-block align-middle"><?php foreach ($errors as $error): ?>
                            <li>
                                <?= esc($error) ?>
                            </li><?php endforeach; ?>
                        </ul>
