...
<head>
    ...
    <style>
        .app-sidebar .nav-link p { margin-bottom: 0; }
        .brand-image { width: 28px; height: 28px; object-fit: contain; }
...
<div class="app-wrapper">
        ...
        <div class="sidebar-wrapper">
            <nav class="mt-2">
                <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu">
                    ...
                    <li class="nav-item"><a href="/" class="nav-link"><i class="nav-icon bi bi-speedometer2"></i><p>Dashboard</p></a></li>
                    <li class="nav-item"><a href="/companies" class="nav-link"><i class="nav-icon bi bi-buildings"></i><p>Perusahaan</p></a></li>
                    <li class="nav-item"><a href="/products" class="nav-link"><i class="nav-icon bi bi-box-seam"></i><p>Katalog Produk</p></a></li>
                    <li class="nav-item"><a href="/quotations" class="nav-link"><i class="nav-icon bi bi-file-earmark-text"></i><p>Penawaran</p></a></li>
                    <li class="nav-header">KONFIGURASI</li>
                    <li class="nav-item"><a href="/settings/quotation" class="nav-link"><i class="nav-icon bi bi-sliders"></i><p>Setting Quotation</p></a></li>
                </ul>
            </nav>
        </div>
    </aside>
    <main class="app-main">
        <div class="app-content-header content-header py-3">
            <div class="container-fluid"><div class="row"><div class="col-sm-6"><h1 class="mb-0"><?= esc($title ?? 'Eprocurement') ?></h1></div></div></div>
        </div>
