...
$routes->group('', ['filter' => 'auth'], static function ($routes) {
    ...
    $routes->post('quotations/(:sha1)/bank-account', 'Quotations::saveBankAccount/$1', ['filter' => 'permission:quotations.status']);
    ...
    $routes->post('settings/quotation/bank-accounts', 'Settings::saveBankAccount', ['filter' => 'permission:settings.quotation']);
    $routes->post('settings/quotation/bank-accounts/(:sha1)', 'Settings::saveBankAccount/$1', ['filter' => 'permission:settings.quotation']);
    $routes->post('settings/quotation/bank-accounts/(:sha1)/delete', 'Settings::deleteBankAccount/$1', ['filter' => 'permission:settings.quotation']);
