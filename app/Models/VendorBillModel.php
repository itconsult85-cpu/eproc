...
class VendorBillModel extends BaseModel
{
    ...
    protected $allowedFields=['vendor_id','purchase_order_id','bill_no','bill_date','due_date','amount','use_ppn','ppn_percent','ppn_amount','use_pph','pph_percent','pph_amount','net_amount','status','paid_date','payment_reference','proof_path','notes','created_at','updated_at'];
